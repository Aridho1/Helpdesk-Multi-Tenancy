...
<template>
    <div>
            ...
            <div class="header-content">
                <div class="header-left">
                    ...
                    <nav class="header-nav">
                        <button type="button" class="nav-link" :class="{ active: router.currentRoute.value.path === '/dashboard' }" @click="router.push('/dashboard')">
                            {{ t("nav.dashboard") }}
                        </button>
                        <button type="button" class="nav-link" :class="{ active: router.currentRoute.value.path === '/tickets' }" @click="router.push('/tickets')">
                            {{ t("nav.tickets") }}
                        </button>
                        <button type="button" class="nav-link" :class="{ active: router.currentRoute.value.path === '/articles' }" @click="router.push('/articles')">
                            {{ t("nav.articles") }}
                        </button>
                        <button
                            v-if="isSuperAdmin"
                ...
                <div class="header-right">
                    <TenantSwitcher />
                    <LanguageSwitcher />
                    <button v-if="authStore.user" type="button" class="user-sidebar-toggle" @click="toggleUserSidebar">
        ...
        <!-- Overlay -->
        <div v-if="isUserSidebarOpen" class="sidebar-overlay" @click="closeUserSidebar"></div>
        ...
        <aside v-if="authStore.user" class="user-sidebar" :class="{ open: isUserSidebarOpen }" :style="sidebarStyle">
            ...
            <div class="user-sidebar-body">
                ...
                <nav class="user-sidebar-nav">
                    <button type="button" class="user-sidebar-nav-link" :class="{ active: router.currentRoute.value.path === '/dashboard' }" @click="navigateTo('/dashboard')">
                        <i class="pi pi-home"></i>
                        <span>{{ t("nav.dashboard") }}</span>
                    </button>
                    <button type="button" class="user-sidebar-nav-link" :class="{ active: router.currentRoute.value.path === '/tickets' }" @click="navigateTo('/tickets')">
                        <i class="pi pi-ticket"></i>
                        <span>{{ t("nav.tickets") }}</span>
                    </button>
                    <button type="button" class="user-sidebar-nav-link" :class="{ active: router.currentRoute.value.path === '/articles' }" @click="navigateTo('/articles')">
                ...
                <!-- Profile Button -->
                <Button id="headerProfileBtn" severity="secondary" size="small" icon="pi pi-user-edit" :label="t('nav.profile')" class="user-sidebar-profile-btn" @click="navigateTo('/profile')" />

                <!-- Logout Button -->
                <Button id="headerLogoutBtn" severity="danger" size="small" :label="t('nav.logout')" class="user-sidebar-logout-btn" @click="handleLogout" />
            </div>
        </aside>
    </div>
</template>
