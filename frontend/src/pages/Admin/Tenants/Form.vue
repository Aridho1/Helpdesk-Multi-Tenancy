...
const handleSubmit = async () => {
    ...
    // InvGate Validation
    if (
        !form.value.invgate_base_url ||
        !form.value.invgate_username ||
                ...
                <div class="form-section">
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <div class="mt-2 p-4 border border-dashed border-gray-300 rounded flex justify-center bg-gray-50 preview-box">
                                <img v-if="form.logo_url" :src="getPreviewUrl(form.logo_url)" alt="Logo Preview" class="logo-preview" @click="openImageModal(getPreviewUrl(form.logo_url))" />
                    ...
                    <div class="mt-6 border rounded overflow-hidden">
                        ...
                        <header class="p-4 flex items-center justify-between" :style="{ backgroundColor: form.primary_color }">
                            <img v-if="form.logo_url" :src="getPreviewUrl(form.logo_url)" alt="Logo" class="logo-header-preview" @click="openImageModal(getPreviewUrl(form.logo_url))" />
