            ...
            <div id="loginTile" class="auth-card">
                ...
                <form @submit.prevent="handleSubmit" class="auth-form">
                    <div class="form-item">
                        ...
                        <InputText id="email" v-model="email" type="email" :placeholder="t('auth.login.emailPlaceholder')" :disabled="isPending" autocomplete="email" class="form-input" />
                    </div>
                    ...
                    <div class="form-actions">
                        <Button type="submit" :label="t('auth.login.signIn')" :loading="isPending" :disabled="!isFormValid || isPending" class="submit-btn" />
                    </div>
