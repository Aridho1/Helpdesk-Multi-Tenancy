...
const breadcrumbItems = computed(() => [{ label: t("tickets.list"), command: () => router.push("/tickets") }, { label: t("tickets.create") }]);
...
const handleSubmit = () => {
    ...
    const dateTimestamp = dateOccurred.value ? Math.floor(new Date(dateOccurred.value).getTime() / 1000) : Math.floor(Date.now() / 1000);
...
<template>
    <div class="create-ticket-page">
        <Breadcrumb id="createTicketBreadcrumb" :model="breadcrumbItems" class="breadcrumb" />
        ...
        <form @submit.prevent="handleSubmit" class="ticket-form">
            ...
            <div class="form-item">
                ...
                <Textarea
                    ...
                    class="form-input" />
                <small v-if="validation.isFieldInvalid('description')" class="error-text">
            ...
            <div class="form-item">
                ...
                <Select
                    ...
                    class="form-input" />
                <ProgressSpinner v-if="categoriesLoading" style="width: 20px; height: 20px; margin-top: 0.5rem" strokeWidth="4" />
                <small v-if="validation.isFieldInvalid('categoryId')" class="error-text">
            ...
            <div class="form-item">
                ...
                <Select
                    ...
                    class="form-input" />
                <ProgressSpinner v-if="metaLoading" style="width: 20px; height: 20px; margin-top: 0.5rem" strokeWidth="4" />
                <small v-if="validation.isFieldInvalid('priorityId')" class="error-text">
            ...
            <div class="form-item">
                ...
                <small v-if="validation.isFieldInvalid('dateOccurred')" class="error-text">
            ...
            <div class="form-item">
                <label for="createTicketFileInput" class="form-label">
                    ...
                    <span class="optional-text">({{ t("tickets.form.optional") }})</span>
                </label>
                <FileUpload
                    v-model:files="files"
                    :disabled="isPending"
            ...
            <div class="form-actions">
                <Button id="createTicketCancelBtn" :label="t('tickets.form.cancel')" severity="secondary" @click="router.push('/tickets')" />
                <Button
